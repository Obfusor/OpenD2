	...
	switch (action)
	{
		...
		case BIND_TOGGLE_AUTOMAP:
			if (pIngame != nullptr)
			{
				...
				if (pAutomap->IsVisible()) pAutomap->Hide(); else pAutomap->Show();
			}
			break;
		...
		case BIND_TOGGLE_INVENTORY:
			if (pIngame != nullptr)
			{
				...
				if (pInv->IsVisible()) pInv->Hide(); else pInv->Show();
			}
			break;
		...
		case BIND_TOGGLE_CHARACTER:
			if (pIngame != nullptr)
			{
				...
				if (pChar->IsVisible()) pChar->Hide(); else pChar->Show();
			}
			break;
		...
		case BIND_TOGGLE_SKILLTREE:
			if (pIngame != nullptr)
			{
				...
				if (pSkills->IsVisible()) pSkills->Hide(); else pSkills->Show();
			}
			break;
		...
		case BIND_TOGGLE_QUESTLOG:
			if (pIngame != nullptr)
			{
				...
				if (pQuests->IsVisible()) pQuests->Hide(); else pQuests->Show();
			}
			break;
