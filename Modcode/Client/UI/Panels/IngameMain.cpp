...
IngameMain::IngameMain()
    : m_newStatButton(nullptr), m_newSkillButton(nullptr), m_questLogButton(nullptr), m_miniPanelButton(nullptr), m_leftAttackButton(nullptr), m_rightAttackButton(nullptr)
{
    x = 0;
    y = 0;
}
