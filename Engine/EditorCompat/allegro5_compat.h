...
// Include Allegro 5.2 headers
// Path resolved via CMake include directories
...
// In Allegro 4 this was unsigned char data[PAL_SIZE][PAL_SIZE] for palette index lookups.
// Used by draw_trans_sprite, draw_lit_sprite, etc. for transparency/lighting blending.
typedef struct
{
...
// Global color map pointer for palette effects (Allegro 4: COLOR_MAP *color_map)
...
// Allegro 4 misc drawing/display functions (stubs)
