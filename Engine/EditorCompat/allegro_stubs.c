...
// ============================================================================
// Allegro 4 sprite drawing stubs (Phase 3B will provide real implementations)
// ============================================================================

void draw_sprite(BITMAP *dest, BITMAP *sprite, int x, int y)
{
    // TODO Phase 3B: Copy non-zero pixels from sprite to dest (8-bit indexed)
    (void)dest; (void)sprite; (void)x; (void)y;
}

void draw_trans_sprite(BITMAP *dest, BITMAP *sprite, int x, int y)
{
    // TODO Phase 3B: Blend via color_map->data[dest_pixel][src_pixel]
    (void)dest; (void)sprite; (void)x; (void)y;
}

void draw_lit_sprite(BITMAP *dest, BITMAP *sprite, int x, int y, int color)
{
    // TODO Phase 3B: Tint via color_map->data[color][src_pixel]
    (void)dest; (void)sprite; (void)x; (void)y; (void)color;
}

void draw_gouraud_sprite(BITMAP *dest, BITMAP *sprite, int x, int y, int c1, int c2, int c3, int c4)
{
    // TODO Phase 3B: Per-pixel interpolated lighting
    (void)dest; (void)sprite; (void)x; (void)y;
    (void)c1; (void)c2; (void)c3; (void)c4;
}

void draw_rle_sprite(BITMAP *dest, RLE_SPRITE *sprite, int x, int y)
{
    // TODO Phase 3B: Draw RLE-compressed sprite
    (void)dest; (void)sprite; (void)x; (void)y;
}

void set_palette(const PALETTE pal)
{
    // In Allegro 5 truecolor mode, palette is handled differently
    (void)pal;
}
